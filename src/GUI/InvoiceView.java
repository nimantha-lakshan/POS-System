...
public class InvoiceView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel.setPreferredSize(new java.awt.Dimension(1170, 660));
        ...
        panel.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 1040, 330));
        ...
        panel.add(cash, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 550, -1, 30));
        ...
        panel.add(card, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 550, -1, 30));
        ...
        panel.add(PaymentMethod, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 530, 300, 60));
        ...
        panel.add(checkAvailability, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 160, 160, 25));
    ...
    public void viewInvoiceData(String invoiceNo) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (rs.getString(12).equals("Cash")) {
                    cash.setSelected(true);
                } else {

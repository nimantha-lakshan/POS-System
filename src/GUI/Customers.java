...
public class Customers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "ID", "Customer", "City", "Contact No"
            }
        ) {
        ...
        if (table.getColumnModel().getColumnCount() > 0) {
            ...
            table.getColumnModel().getColumn(4).setPreferredWidth(203);
        }

        panel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 1090, 460));
    ...
    public void loadTableData() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) table.getModel();
            ResultSet rs = DB.search("SELECT id_customer,fname,lname,city,mobile FROM customer WHERE state = 1");
            int rawNo = 0;
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();

...
public class Sales_Returns extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        invoiceId = new javax.swing.JComboBox<>();
        ...
        panel.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 80, 25));

        date.setDateFormatString("yyyy-MM-dd");
        date.setFont(new java.awt.Font("Calibri", 0, 16)); // NOI18N
        panel.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 90, 180, 25));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stock ID", "Product Code", "Product", "Unit", "Unit Price", "Quantity", "Amount", "Return Quantity"
            }
        ) {
        ...
        panel.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 240, 1050, 400));
        ...
        panel.add(btn_Cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 130, 90, 30));
        ...
        panel.add(btn_Save, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 80, 90, 30));
        ...
        panel.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 655, 120, 30));
        ...
        panel.add(txt_SRNvalue, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 655, 170, 30));
        ...
        panel.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 60, 25));

        srnNo.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        srnNo.setForeground(new java.awt.Color(66, 73, 73));
        panel.add(srnNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 90, 200, 25));

        invoiceId.setEditable(true);
        invoiceId.setFont(new java.awt.Font("Calibri", 0, 16)); // NOI18N
        invoiceId.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Select -" }));
        ...
        panel.add(invoiceId, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 190, 200, 25));

        jLabel7.setFont(new java.awt.Font("Calibri", 0, 16)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(66, 73, 73));
        jLabel7.setText("Date");
        panel.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 90, 40, 25));
        ...
        panel.add(invoiceValue, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 190, 140, 25));
        ...
        panel.add(invoiceDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 190, 140, 25));
        ...
        panel.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 190, 90, 25));
        ...
        panel.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 190, 90, 25));
        panel.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 150, 730, 10));
    ...
    private void invoiceIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_invoiceIdActionPerformed
        if (invoiceId.getSelectedIndex() != 0) {
            viewInvoiceData(invoiceId.getSelectedItem().toString());
        }
        ...
        if (invoiceId.getSelectedIndex() == 0) {
            ...
            if (txt_SRNvalue.getText().equals("00.00") | txt_SRNvalue.getText().equals("0.00") | txt_SRNvalue.getText().isEmpty()) {
                ...
                if (JOptionPane.showConfirmDialog(this, "Are you sure?, you want Return this items", "Return the Invoice", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE) == 0) {
                    ...
                    try {
                        DB.iud("INSERT INTO sales_return VALUES ('" + srnNo.getText() + "','" + invoiceId.getSelectedItem().toString() + "','" + dateFormat.format(new Date()) + "','" + timeFormat.format(new Date()) + "','" + txt_SRNvalue.getText() + "')");
    ...
    private javax.swing.JComboBox<String> invoiceId;
    ...
    private void loadInvoice() {
        try {
            ResultSet rs = DB.search("SELECT id_invoice FROM invoice WHERE state='1' ORDER BY `date` DESC");
            while (rs.next()) {
                invoiceId.addItem(rs.getString(1));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void getSRNValue() {
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            ...
            totalValue = totalValue + (unitPrice * returnQty);
        }

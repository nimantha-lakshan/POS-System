...
public class Select_Stock extends javax.swing.JFrame {
    ...
    private void loadStock(String productCode) {
        ...
        for (int i = 0; i < invoice.table.getRowCount(); i++) {
            if (invoice.table.getValueAt(i, 2).toString().equals(productCode)) {
                avaQty = Double.parseDouble(invoice.table.getValueAt(i, 5).toString());
            }
        }
